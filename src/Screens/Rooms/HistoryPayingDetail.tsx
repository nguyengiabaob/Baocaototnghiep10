...
const HistoryPayingDetail:React.FC <props> =({visible, viewStyle, idBill, onCancel})=>{
     ...
     return (
         <Overlay isVisible={visible} >
            <SafeAreaView style={[viewStyle]}>
                ...
                <View>
                    {
                       ListProduct ? ListProduct.filter(x=>x.BillId == Bill.id).map(x=> {
                           return (
                            <View
                            style={{
                ...
                <View>
                    <TouchableOpacity style={styles.btnExit} onPress={()=> {onCancel(false)}} >
                        <Text>thoát</Text>
                    </TouchableOpacity>
                </View>
            </SafeAreaView>
