    ...
    return (
        <View style={{flex:1}}>
            ...
            <View style={{justifyContent:'center', alignItems:'center',marginTop:35}}>
                <TextInput onChangeText={(text)=>{setnameCustomer(text)}} placeholder="Tên khách hàng"  mode="outlined" outlineColor="#02569E" style={{width:reponsivewidth(350)}}/>
            </View>
            <View style={{justifyContent:'center', alignItems:'center',marginTop:35}}>
                <TextInput  editable={false}  mode="outlined" outlineColor="#02569E" style={{width:reponsivewidth(350)}} right={<TextInput.Icon onPress={()=>setshowdatepicker(true)} name="calendar-today" />}>{transferday(showdatepickervalue)}</TextInput>
               ...
               <View style={{justifyContent:'center', alignItems:'center',marginTop:35}}>
                <TextInput onBlur={()=>{setTimeValue(time.toString())}}  mode="outlined" outlineColor="#02569E" style={{width:reponsivewidth(350)}} right={<TextInput.Icon onPress={()=>setshowtime(true)} name="clock"/>}>{time.getHours()+ ":" + time.getMinutes()}</TextInput>
            ...
            <View style={{justifyContent:'center', alignItems:'center',marginTop:35}}>
                <TextInput onChangeText={(text)=>setSlots(Number(text))} placeholder="Số người "  mode="outlined" outlineColor="#02569E" style={{width:reponsivewidth(350)}}/>
            </View>
            <View style={{justifyContent:'center', alignItems:'center',marginTop:35}}>
