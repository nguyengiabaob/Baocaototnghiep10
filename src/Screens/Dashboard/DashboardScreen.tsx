        ...
        <View style={style.container}>
            <View style={style.Top} >
                ...
                <View style={{ marginTop:15 ,flex:1}}>
                    <Pressable >
                        <Bell style={{alignSelf:'flex-end'}} width={reponsivewidth(35)} height={reponsiveheight(35)}  />
                    </Pressable>
                </View>
           </View>
           ...
           <ScrollView  style={{marginTop:25, flex:1}}>
               <View style={style.ContainerButton}>
                <CustomButton
                 ...
                 icon={ <MaterialCommunityIcons name="file-table-box-multiple" color={'#02569E'}  size={65}/>
                 }
                />
                 <CustomButton
                 textStyle={ {color:'#02569E'}}
                ...
                />
                 <CustomButton
                 textStyle={ {color:'#02569E'}}
                 onpress={()=>{navigation.navigate('ChartNavigation')}}
                 viewstyle={[style.shadowsContainer,{backgroundColor: '#ffff'}]}
                 title="Thống kê doanh thu"
                 icon={ <FontAwesome name="pie-chart" size={65} color={'#02569E'}/>
                 }
                />
                </View>
                <View style={style.ContainerButton}>
                <CustomButton
                 ...
                 icon={ <FontAwesome5 name="box-open" size={65} color={'#02569E'}/>
                 }
                />
                </View>
           </ScrollView>
